...
@test "nuget install latest log4net" {
  run /bin/bash -c "cd nuget && nuget install log4net -DisableParallelProcessing -NoCache -Source http://baget:9090/cache/v3/index.json"
  assert_output --partial "OK http://baget:9090/cache/v3/registration/log4net/index.json"
